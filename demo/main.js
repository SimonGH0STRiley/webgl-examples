...
function main() {
	...
	const vsSource = `
		...
		void main() {
			// modelViewePosition = (u_modelViewMatrix * a_position).xyz;
  ...
  function drawScene(time) {
	...
	topConeUniforms.u_matrix = computeMatrix(viewProjectionMatrix, topConeTranslation, topConeXRotation, topConeYRotation);
	bottomConeUniforms.u_matrix = computeMatrix(viewProjectionMatrix, bottomConeTranslation, bottomConeXRotation, bottomConeYRotation);
